class lotes:
    ...
    def todic(self):
        return {
            "id": self.lot_id,
            "numero": self.lot_numero,
            "fecha_fabricacion": str(self.lot_fecha_fabricacion) if self.lot_fecha_fabricacion else None,
            "fecha_vencimiento": str(self.lot_fecha_vencimiento) if self.lot_fecha_vencimiento else None,
            "cantidad_inicial": self.lot_cantidad_inicial,
            "cantidad_actual": self.lot_cantidad_actual,
            "producto_id": self.lot_pro_id_fk,
            "proveedor_id": self.lot_prov_id_fk,
            "estado": self.lot_estado
        }